...
<span style="color:red"><b>UPDATE:</b> Now Geo-ER supports json formatted neighbors for entities, to make it easier to use it for other tasks and dataset.</span>.
